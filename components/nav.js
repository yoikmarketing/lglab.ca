...
import { HiOutlineMenu, HiChevronDown, HiOutlineChartBar, HiOutlineCursorClick, HiOutlineShieldCheck, HiOutlineViewGrid, HiOutlineRefresh, HiOutlinePlay, HiOutlinePhone, HiOutlineSupport, HiOutlineBookmarkAlt, HiOutlineCalendar, HiOutlineX } from "react-icons/hi"
        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <nav className="hidden md:flex space-x-10">
            <div className="relative">
              <button type="button" onClick={toggleSolutions} className={`${isSolutionsOpen ? "text-gray-900" : "text-gray-500"} group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500`} aria-expanded="false">
                <span>Solutions</span>
                <HiChevronDown className={`${isSolutionsOpen ? "text-gray-600" : "text-gray-400"} ml-2 h-5 w-5 group-hover:text-gray-500`} />
              </button>
